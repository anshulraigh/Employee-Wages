...
// Example Usage
const emp1 = new EmployeePayroll(101, "Anshul", 55000, "M", "2023-05-10");  
const emp2 = new EmployeePayroll(-5, "Aman", 77000, "M", "2022-11-15"); 
const emp3 = new EmployeePayroll(103, "Harshil", -3000, "M", "2024-01-20"); 
const emp4 = new EmployeePayroll(104, "Deepak", 6000, "X", "2023-06-01"); 
const emp5 = new EmployeePayroll(105, "Aditi", 8000, "F", "2026-04-01"); 
